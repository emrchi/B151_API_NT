...
public class HerokuAppTestData {
    ...
    public Map<String, String> bookingDatesMapper(String checkin, String checkout){
    ...
    public Map<String, Object> expectedDataMapper(String firstname,String lastname,Integer totalprice,Boolean depositpaid,
